      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          {tags.map((tag) => (
            <span
              key={tag.en}
              className="rounded-full border border-slate-200 bg-[#e8ecf3] px-4 py-2 text-sm font-medium text-slate-700 backdrop-blur-sm dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"
            >
              {t(tag, locale)}
            </span>
          ))}
